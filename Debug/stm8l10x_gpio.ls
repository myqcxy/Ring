 ...
 109                     ; 44 void GPIO_DeInit(GPIO_TypeDef* GPIOx)
 109                     ; 45 {
 111                     	switch	.text
 112  0000               _GPIO_DeInit:
 116                     ; 46     GPIOx->ODR = GPIO_ODR_RESET_VALUE; /* Reset Output Data Register */
 118  0000 7f            	clr	(x)
 119                     ; 47     GPIOx->DDR = GPIO_DDR_RESET_VALUE; /* Reset Data Direction Register */
 121  0001 6f02          	clr	(2,x)
 122                     ; 48     GPIOx->CR1 = GPIO_CR1_RESET_VALUE; /* Reset Control Register 1 */
 124  0003 6f03          	clr	(3,x)
 125                     ; 49     GPIOx->CR2 = GPIO_CR2_RESET_VALUE; /* Reset Control Register 2 */
 127  0005 6f04          	clr	(4,x)
 128                     ; 50 }
 131  0007 81            	ret
 287                     ; 60 void GPIO_Init(GPIO_TypeDef* GPIOx,
 287                     ; 61                uint8_t GPIO_Pin,
 287                     ; 62                GPIO_Mode_TypeDef GPIO_Mode)
 287                     ; 63 {
 288                     	switch	.text
 289  0008               _GPIO_Init:
 291  0008 89            	pushw	x
 292       00000000      OFST:	set	0
 295                     ; 68     assert_param(IS_GPIO_MODE(GPIO_Mode));
 297                     ; 69     assert_param(IS_GPIO_PIN(GPIO_Pin));
 299                     ; 75     if ((((uint8_t)(GPIO_Mode)) & (uint8_t)0x80) != (uint8_t)0x00) /* Output mode */
 301  0009 7b06          	ld	a,(OFST+6,sp)
 302  000b a580          	bcp	a,#128
 303  000d 271d          	jreq	L541
 304                     ; 77         if ((((uint8_t)(GPIO_Mode)) & (uint8_t)0x10) != (uint8_t)0x00) /* High level */
 306  000f 7b06          	ld	a,(OFST+6,sp)
 307  0011 a510          	bcp	a,#16
 308  0013 2706          	jreq	L741
 309                     ; 79             GPIOx->ODR |= GPIO_Pin;
 311  0015 f6            	ld	a,(x)
 312  0016 1a05          	or	a,(OFST+5,sp)
 313  0018 f7            	ld	(x),a
 315  0019 2007          	jra	L151
 316  001b               L741:
 317                     ; 82             GPIOx->ODR &= (uint8_t)(~(GPIO_Pin));
 ...
 333  002c               L541:
 334                     ; 89         GPIOx->DDR &= (uint8_t)(~(GPIO_Pin));
 ...
 341  0035               L351:
 342                     ; 96     if ((((uint8_t)(GPIO_Mode)) & (uint8_t)0x40) != (uint8_t)0x00) /* Pull-Up or Push-Pull */
 344  0035 7b06          	ld	a,(OFST+6,sp)
 345  0037 a540          	bcp	a,#64
 346  0039 270a          	jreq	L551
 347                     ; 98         GPIOx->CR1 |= GPIO_Pin;
 ...
 355  0045               L551:
 356                     ; 101         GPIOx->CR1 &= (uint8_t)(~(GPIO_Pin));
 ...
 363  004e               L751:
 364                     ; 108     if ((((uint8_t)(GPIO_Mode)) & (uint8_t)0x20) != (uint8_t)0x00) /* Interrupt or Slow slope */
 366  004e 7b06          	ld	a,(OFST+6,sp)
 367  0050 a520          	bcp	a,#32
 368  0052 270a          	jreq	L161
 369                     ; 110         GPIOx->CR2 |= GPIO_Pin;
 ...
 377  005e               L161:
 378                     ; 113         GPIOx->CR2 &= (uint8_t)(~(GPIO_Pin));
 ...
 389  0067 85            	popw	x
 390  0068 81            	ret
 436                     ; 127 void GPIO_Write(GPIO_TypeDef* GPIOx, uint8_t GPIO_PortVal)
 436                     ; 128 {
 437                     	switch	.text
 438  0069               _GPIO_Write:
 440  0069 89            	pushw	x
 441       00000000      OFST:	set	0
 444                     ; 129     GPIOx->ODR = GPIO_PortVal;
 ...
 452  006f 85            	popw	x
 453  0070 81            	ret
 613                     ; 140 void GPIO_WriteBit(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin, BitAction GPIO_BitVal)
 613                     ; 141 {
 614                     	switch	.text
 615  0071               _GPIO_WriteBit:
 617  0071 89            	pushw	x
 618       00000000      OFST:	set	0
 621                     ; 143     assert_param(IS_GPIO_PIN(GPIO_Pin));
 623                     ; 144     assert_param(IS_STATE_VALUE(GPIO_BitVal));
 625                     ; 146     if (GPIO_BitVal != RESET)
 627  0072 0d06          	tnz	(OFST+6,sp)
 628  0074 2715          	jreq	L303
 629                     ; 148         SetBit(GPIOx->ODR,GPIO_Pin);
 ...
 646  008b               L303:
 647                     ; 153         ClrBit(GPIOx->ODR,GPIO_Pin);
 ...
 668  00a2 85            	popw	x
 669  00a3 81            	ret
 715                     ; 167 void GPIO_SetBits(GPIO_TypeDef* GPIOx, uint8_t GPIO_Pin)
 715                     ; 168 {
 716                     	switch	.text
 717  00a4               _GPIO_SetBits:
 719  00a4 89            	pushw	x
 720       00000000      OFST:	set	0
 723                     ; 169     GPIOx->ODR |= GPIO_Pin;
 725  00a5 f6            	ld	a,(x)
 ...
 731  00a9 85            	popw	x
 732  00aa 81            	ret
 778                     ; 181 void GPIO_ResetBits(GPIO_TypeDef* GPIOx, uint8_t GPIO_Pin)
 778                     ; 182 {
 779                     	switch	.text
 780  00ab               _GPIO_ResetBits:
 782  00ab 89            	pushw	x
 783       00000000      OFST:	set	0
 786                     ; 183     GPIOx->ODR &= (uint8_t)(~GPIO_Pin);
 ...
 795  00b1 85            	popw	x
 796  00b2 81            	ret
 842                     ; 195 void GPIO_ToggleBits(GPIO_TypeDef* GPIOx, uint8_t GPIO_Pin)
 842                     ; 196 {
 843                     	switch	.text
 844  00b3               _GPIO_ToggleBits:
 846  00b3 89            	pushw	x
 847       00000000      OFST:	set	0
 850                     ; 197     GPIOx->ODR ^= GPIO_Pin;
 852  00b4 f6            	ld	a,(x)
 ...
 858  00b8 85            	popw	x
 859  00b9 81            	ret
 896                     ; 207 uint8_t GPIO_ReadInputData(GPIO_TypeDef* GPIOx)
 896                     ; 208 {
 897                     	switch	.text
 898  00ba               _GPIO_ReadInputData:
 902                     ; 209     return ((uint8_t)GPIOx->IDR);
 904  00ba e601          	ld	a,(1,x)
 907  00bc 81            	ret
 945                     ; 218 uint8_t GPIO_ReadOutputData(GPIO_TypeDef* GPIOx)
 945                     ; 219 {
 946                     	switch	.text
 947  00bd               _GPIO_ReadOutputData:
 951                     ; 220     return ((uint8_t)GPIOx->ODR);
 953  00bd f6            	ld	a,(x)
 956  00be 81            	ret
1005                     ; 232 BitStatus GPIO_ReadInputDataBit(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin)
1005                     ; 233 {
1006                     	switch	.text
1007  00bf               _GPIO_ReadInputDataBit:
1009  00bf 89            	pushw	x
1010       00000000      OFST:	set	0
1013                     ; 234     return ((BitStatus)(GPIOx->IDR & (uint8_t)GPIO_Pin));
1015  00c0 e601          	ld	a,(1,x)
1016  00c2 1405          	and	a,(OFST+5,sp)
1019  00c4 85            	popw	x
1020  00c5 81            	ret
1069                     ; 246 BitStatus GPIO_ReadOutputDataBit(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin)
1069                     ; 247 {
1070                     	switch	.text
1071  00c6               _GPIO_ReadOutputDataBit:
1073  00c6 89            	pushw	x
1074       00000000      OFST:	set	0
1077                     ; 248     return ((BitStatus)(GPIOx->ODR & (uint8_t)GPIO_Pin));
1079  00c7 f6            	ld	a,(x)
1080  00c8 1405          	and	a,(OFST+5,sp)
1083  00ca 85            	popw	x
1084  00cb 81            	ret
1161                     ; 259 void GPIO_ExternalPullUpConfig(GPIO_TypeDef* GPIOx, uint8_t GPIO_Pin, FunctionalState NewState)
1161                     ; 260 {
1162                     	switch	.text
1163  00cc               _GPIO_ExternalPullUpConfig:
1165  00cc 89            	pushw	x
1166       00000000      OFST:	set	0
1169                     ; 262     assert_param(IS_GPIO_PIN(GPIO_Pin));
1171                     ; 263     assert_param(IS_FUNCTIONAL_STATE(NewState));
1173                     ; 265     if (NewState!=DISABLE) /* External Pull-Up Set*/
1175  00cd 0d06          	tnz	(OFST+6,sp)
1176  00cf 2708          	jreq	L355
1177                     ; 267         GPIOx->CR1 |= GPIO_Pin;
1179  00d1 e603          	ld	a,(3,x)
1180  00d3 1a05          	or	a,(OFST+5,sp)
1181  00d5 e703          	ld	(3,x),a
1183  00d7 2009          	jra	L555
1184  00d9               L355:
1185                     ; 270         GPIOx->CR1 &= (uint8_t)(~(GPIO_Pin));
