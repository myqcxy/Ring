  ...
  43                     ; 45 void EXTI_DeInit(void)
  43                     ; 46 {
  45                     	switch	.text
  46  0000               _EXTI_DeInit:
  50                     ; 47     EXTI->CR1 = EXTI_CR1_RESET_VALUE;
  52  0000 725f50a0      	clr	20640
  53                     ; 48     EXTI->CR2 = EXTI_CR2_RESET_VALUE;
  55  0004 725f50a1      	clr	20641
  56                     ; 49     EXTI->CR3 = EXTI_CR3_RESET_VALUE;
  58  0008 725f50a2      	clr	20642
  59                     ; 50     EXTI->SR1 = EXTI_SR1_RESET_VALUE;
  61  000c 725f50a3      	clr	20643
  62                     ; 51     EXTI->SR2 = EXTI_SR2_RESET_VALUE;
  64  0010 725f50a4      	clr	20644
  65                     ; 52     EXTI->CONF = EXTI_CONF_RESET_VALUE;
  67  0014 725f50a5      	clr	20645
  68                     ; 53 }
  71  0018 81            	ret
 175                     ; 68 void EXTI_SetPortSensitivity(EXTI_Port_TypeDef EXTI_Port,
 175                     ; 69                              EXTI_Trigger_TypeDef EXTI_TriggerValue)
 175                     ; 70 {
 176                     	switch	.text
 177  0019               _EXTI_SetPortSensitivity:
 179  0019 89            	pushw	x
 180       00000000      OFST:	set	0
 183                     ; 73     assert_param(IS_EXTI_PORT(EXTI_Port));
 185                     ; 74     assert_param(IS_EXTI_Trigger_VALUE(EXTI_TriggerValue));
 187                     ; 77     if (EXTI_Port != EXTI_Port_B)
 189  001a 9e            	ld	a,xh
 190  001b 4d            	tnz	a
 191  001c 270a          	jreq	L76
 192                     ; 79         EXTI->CR3 &= (uint8_t)(~EXTI_CR3_PDIS);
 194  001e c650a2        	ld	a,20642
 195  0021 a4f3          	and	a,#243
 196  0023 c750a2        	ld	20642,a
 198  0026 2008          	jra	L17
 199  0028               L76:
 200                     ; 83         EXTI->CR3 &= (uint8_t)(~EXTI_CR3_PBIS);
 202  0028 c650a2        	ld	a,20642
 203  002b a4fc          	and	a,#252
 204  002d c750a2        	ld	20642,a
 205  0030               L17:
 206                     ; 87     EXTI->CR3 |= (uint8_t)((uint8_t)(EXTI_TriggerValue) << EXTI_Port);
 ...
 224  0043 85            	popw	x
 225  0044 81            	ret
 333                     ; 104 void EXTI_SetPinSensitivity(EXTI_Pin_TypeDef EXTI_PinNum,
 333                     ; 105                             EXTI_Trigger_TypeDef EXTI_TriggerValue)
 333                     ; 106 {
 334                     	switch	.text
 335  0045               _EXTI_SetPinSensitivity:
 337  0045 89            	pushw	x
 338       00000000      OFST:	set	0
 341                     ; 109     assert_param(IS_EXTI_PINNUM(EXTI_PinNum));
 343                     ; 110     assert_param(IS_EXTI_Trigger_VALUE(EXTI_TriggerValue));
 345                     ; 113     switch (EXTI_PinNum)
 347  0046 9e            	ld	a,xh
 349                     ; 147     default:
 349                     ; 148         break;
 350  0047 4d            	tnz	a
 ...
 375  0079               L37:
 376                     ; 115     case EXTI_Pin_0:
 376                     ; 116         EXTI->CR1 &=  (uint8_t)(~EXTI_CR1_P0IS);
 378  0079 c650a0        	ld	a,20640
 379  007c a4fc          	and	a,#252
 380  007e c750a0        	ld	20640,a
 381                     ; 117         EXTI->CR1 |= (uint8_t)((uint8_t)(EXTI_TriggerValue) << EXTI_PinNum);
 ...
 399  0098               L57:
 400                     ; 119     case EXTI_Pin_1:
 400                     ; 120         EXTI->CR1 &=  (uint8_t)(~EXTI_CR1_P1IS);
 402  0098 c650a0        	ld	a,20640
 403  009b a4f3          	and	a,#243
 404  009d c750a0        	ld	20640,a
 405                     ; 121         EXTI->CR1 |= (uint8_t)((uint8_t)(EXTI_TriggerValue) << EXTI_PinNum);
 ...
 423  00b7               L77:
 424                     ; 123     case EXTI_Pin_2:
 424                     ; 124         EXTI->CR1 &=  (uint8_t)(~EXTI_CR1_P2IS);
 426  00b7 c650a0        	ld	a,20640
 427  00ba a4cf          	and	a,#207
 428  00bc c750a0        	ld	20640,a
 429                     ; 125         EXTI->CR1 |= (uint8_t)((uint8_t)(EXTI_TriggerValue) << EXTI_PinNum);
 ...
 447  00d6               L101:
 448                     ; 127     case EXTI_Pin_3:
 448                     ; 128         EXTI->CR1 &=  (uint8_t)(~EXTI_CR1_P3IS);
 450  00d6 c650a0        	ld	a,20640
 451  00d9 a43f          	and	a,#63
 452  00db c750a0        	ld	20640,a
 453                     ; 129         EXTI->CR1 |= (uint8_t)((uint8_t)(EXTI_TriggerValue) << EXTI_PinNum);
 ...
 471  00f3               L301:
 472                     ; 131     case EXTI_Pin_4:
 472                     ; 132         EXTI->CR2 &=  (uint8_t)(~EXTI_CR2_P4IS);
 474  00f3 c650a1        	ld	a,20641
 475  00f6 a4fc          	and	a,#252
 476  00f8 c750a1        	ld	20641,a
 477                     ; 133         EXTI->CR2 |= (uint8_t)((uint8_t)(EXTI_TriggerValue) << ((uint8_t)EXTI_PinNum & (uint8_t)0xEF));
 ...
 496  0112               L501:
 497                     ; 135     case EXTI_Pin_5:
 497                     ; 136         EXTI->CR2 &=  (uint8_t)(~EXTI_CR2_P5IS);
 499  0112 c650a1        	ld	a,20641
 500  0115 a4f3          	and	a,#243
 501  0117 c750a1        	ld	20641,a
 502                     ; 137         EXTI->CR2 |= (uint8_t)((uint8_t)(EXTI_TriggerValue) << ((uint8_t)EXTI_PinNum & (uint8_t)0xEF));
 ...
 521  0131               L701:
 522                     ; 139     case EXTI_Pin_6:
 522                     ; 140         EXTI->CR2 &=  (uint8_t)(~EXTI_CR2_P6IS);
 524  0131 c650a1        	ld	a,20641
 525  0134 a4cf          	and	a,#207
 526  0136 c750a1        	ld	20641,a
 527                     ; 141         EXTI->CR2 |= (uint8_t)((uint8_t)(EXTI_TriggerValue) << ((uint8_t)EXTI_PinNum & (uint8_t)0xEF));
 ...
 546  0150               L111:
 547                     ; 143     case EXTI_Pin_7:
 547                     ; 144         EXTI->CR2 &=  (uint8_t)(~EXTI_CR2_P7IS);
 549  0150 c650a1        	ld	a,20641
 550  0153 a43f          	and	a,#63
 551  0155 c750a1        	ld	20641,a
 552                     ; 145         EXTI->CR2 |= (uint8_t)((uint8_t)(EXTI_TriggerValue) << ((uint8_t)EXTI_PinNum & (uint8_t)0xEF));
 ...
 577  016d 85            	popw	x
 578  016e 81            	ret
 682                     ; 163 void EXTI_SetHalfPortSelection(EXTI_HalfPort_TypeDef EXTI_HalfPort,
 682                     ; 164                                FunctionalState NewState)
 682                     ; 165 {
 683                     	switch	.text
 684  016f               _EXTI_SetHalfPortSelection:
 686  016f 89            	pushw	x
 687       00000000      OFST:	set	0
 690                     ; 167     assert_param(IS_EXTI_HALFPORT(EXTI_HalfPort));
 692                     ; 168     assert_param(IS_FUNCTIONAL_STATE(NewState));
 694                     ; 170     if (NewState != DISABLE)
 696  0170 9f            	ld	a,xl
 697  0171 4d            	tnz	a
 698  0172 2709          	jreq	L532
 699                     ; 172         EXTI->CONF |= (uint8_t)EXTI_HalfPort; /* Enable port interrupt selector */
 701  0174 9e            	ld	a,xh
 702  0175 ca50a5        	or	a,20645
 703  0178 c750a5        	ld	20645,a
 705  017b 2009          	jra	L732
 706  017d               L532:
 707                     ; 176         EXTI->CONF &= (uint8_t)(~(uint8_t)EXTI_HalfPort); /* Disable port interrupt selector */
 ...
 717  0186 85            	popw	x
 718  0187 81            	ret
 764                     ; 186 EXTI_Trigger_TypeDef EXTI_GetPortSensitivity(EXTI_Port_TypeDef EXTI_Port)
 764                     ; 187 {
 765                     	switch	.text
 766  0188               _EXTI_GetPortSensitivity:
 768  0188 88            	push	a
 769       00000001      OFST:	set	1
 772                     ; 188     uint8_t value = 0;
 774                     ; 191     assert_param(IS_EXTI_PORT(EXTI_Port));
 776                     ; 193     if (EXTI_Port != EXTI_Port_B)
 778  0189 4d            	tnz	a
 779  018a 270b          	jreq	L362
 780                     ; 195         value = (uint8_t)((EXTI->CR3 & EXTI_CR3_PDIS)>>2);
 ...
 789  0197               L362:
 790                     ; 199         value = (uint8_t)(EXTI->CR3 & EXTI_CR3_PBIS);
 792  0197 c650a2        	ld	a,20642
 793  019a a403          	and	a,#3
 794  019c 6b01          	ld	(OFST+0,sp),a
 795  019e               L562:
 796                     ; 201     return((EXTI_Trigger_TypeDef)value);
 798  019e 7b01          	ld	a,(OFST+0,sp)
 801  01a0 5b01          	addw	sp,#1
 802  01a2 81            	ret
 848                     ; 210 EXTI_Trigger_TypeDef EXTI_GetPinSensitivity(EXTI_Pin_TypeDef EXTI_PinNum)
 848                     ; 211 {
 849                     	switch	.text
 850  01a3               _EXTI_GetPinSensitivity:
 852  01a3 88            	push	a
 853       00000001      OFST:	set	1
 856                     ; 212     uint8_t value = 0;
 858  01a4 0f01          	clr	(OFST+0,sp)
 859                     ; 215     assert_param(IS_EXTI_PINNUM(EXTI_PinNum));
 861                     ; 217     switch (EXTI_PinNum)
 864                     ; 243     default:
 864                     ; 244         break;
 865  01a6 4d            	tnz	a
 ...
 882  01c7               L762:
 883                     ; 219     case EXTI_Pin_0:
 883                     ; 220         value = (uint8_t)(EXTI->CR1 & EXTI_CR1_P0IS);
 ...
 891  01d0               L172:
 892                     ; 222     case EXTI_Pin_1:
 892                     ; 223         value = (uint8_t)((EXTI->CR1 & EXTI_CR1_P1IS) >> EXTI_Pin_1);
 ...
 902  01db               L372:
 903                     ; 225     case EXTI_Pin_2:
 903                     ; 226         value = (uint8_t)((EXTI->CR1 & EXTI_CR1_P2IS) >> EXTI_Pin_2);
 ...
 913  01e7               L572:
 914                     ; 228     case EXTI_Pin_3:
 914                     ; 229         value = (uint8_t)((EXTI->CR1 & EXTI_CR1_P3IS) >> EXTI_Pin_3);
 ...
 926  01f5               L772:
 927                     ; 231     case EXTI_Pin_4:
 927                     ; 232         value = (uint8_t)(EXTI->CR2 & EXTI_CR2_P4IS);
 ...
 935  01fe               L103:
 936                     ; 234     case EXTI_Pin_5:
 936                     ; 235         value = (uint8_t)((EXTI->CR2 & EXTI_CR2_P5IS) >> ((uint8_t)EXTI_Pin_5 & (uint8_t)0x0F));
 ...
 946  0209               L303:
 947                     ; 237     case EXTI_Pin_6:
 947                     ; 238         value = (uint8_t)((EXTI->CR2 & EXTI_CR2_P6IS) >> ((uint8_t)EXTI_Pin_6 & (uint8_t)0x0F));
 ...
 957  0215               L503:
 958                     ; 240     case EXTI_Pin_7:
 958                     ; 241         value = (uint8_t)((EXTI->CR2 & EXTI_CR2_P7IS) >> ((uint8_t)EXTI_Pin_7 & (uint8_t)0x0F));
 ...
 970                     ; 244         break;
 972  0221               L533:
 973                     ; 246     return((EXTI_Trigger_TypeDef)value);
 975  0221 7b01          	ld	a,(OFST+0,sp)
 978  0223 5b01          	addw	sp,#1
 979  0225 81            	ret
1026                     ; 256 FunctionalState EXTI_GetHalfPortSelection(EXTI_HalfPort_TypeDef EXTI_HalfPort)
1026                     ; 257 {
1027                     	switch	.text
1028  0226               _EXTI_GetHalfPortSelection:
1030  0226 88            	push	a
1031       00000001      OFST:	set	1
1034                     ; 258     FunctionalState value = DISABLE;
1036                     ; 260     assert_param(IS_EXTI_HALFPORT(EXTI_HalfPort));
1038                     ; 261     if ((EXTI->CONF & (uint8_t)EXTI_HalfPort) != DISABLE)
1040  0227 c450a5        	and	a,20645
1041  022a 2706          	jreq	L163
1042                     ; 263         value = ENABLE;
1044  022c a601          	ld	a,#1
1045  022e 6b01          	ld	(OFST+0,sp),a
1047  0230 2002          	jra	L363
1048  0232               L163:
1049                     ; 267         value = DISABLE;
1051  0232 0f01          	clr	(OFST+0,sp)
1052  0234               L363:
1053                     ; 270     return(value);
1055  0234 7b01          	ld	a,(OFST+0,sp)
1058  0236 5b01          	addw	sp,#1
1059  0238 81            	ret
1201                     ; 280 ITStatus EXTI_GetITStatus(EXTI_IT_TypeDef EXTI_IT)
1201                     ; 281 {
1202                     	switch	.text
...
1210                     ; 282     ITStatus status = RESET;
1212                     ; 284     assert_param(IS_EXTI_ITPENDINGBIT(EXTI_IT));
1214                     ; 286     if (((uint8_t)EXTI_IT & (uint8_t)0xF0) == 0xF0)
1216  023b a4f0          	and	a,#240
1217  023d a1f0          	cp	a,#240
1218  023f 260b          	jrne	L744
1219                     ; 288         status = (ITStatus)(EXTI->SR2 & ((uint8_t)EXTI_IT & (uint8_t)0x0F));
